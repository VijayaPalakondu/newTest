...
const capabilities = {
 ...
 'os_version' : '14.0',
 'browserName' : 'iphone',
 'name': ' VBR Sample Test', // test name
 'build': 'BStack Build Number 1' // CI/CD job or build name
}
async function runTestWithCaps () {
  let driver = new webdriver.Builder().usingServer(`https://vijayapalakondu_3pEr9P:iLtY6yDcE7rmg5eACF5b@hub-cloud.browserstack.com/wd/hub`).withCapabilities(capabilities).build();
  try{
